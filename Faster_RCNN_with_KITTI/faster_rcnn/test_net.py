...
def parse_args():
    ...
    parser.add_argument('--weights', dest='model',
                        help='model to test',
                        default="./output/default/kittivoc_train/", type=str)

    parser.add_argument('--cfg', dest='cfg_file',
                        help='cfg file needed', default="./experiments/cfgs/faster_rcnn_kitti.yml", type=str)
    ...
    parser.add_argument('--imdb', dest='imdb_name',
                        ...
                        default='kittivoc_test', type=str)
